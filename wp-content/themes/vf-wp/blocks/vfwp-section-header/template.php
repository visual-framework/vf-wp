  ...
  <?php
    if ($type === 'is_a_link' || $type === 'has_sub-heading_and_link' || $type === 'has_sub-heading_link_text' || $type === 'has_link_text') { 
      ...
      if (is_array($link_url) && isset($link_url['url'])) {
        ...
        $link_target = $link_url['target']; // Extract URL from array
