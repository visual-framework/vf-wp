...
if ($type) {
  if (
    ...
    $admin_banner(__('Please enter custom content for this links list.', 'vfwp'));
    return;
  }
?>
<div class="<?php echo esc_attr($class_div); ?>">
  ...
  if($list_items) { ?>
    ...
    <li class="vf-list__item">
      <a class="vf-list__link" href="<?php echo $list_item['url']?>">

      <?php if ($type === 'has-image') { ?>
        <img class="vf-list__image" src="<?php echo $list_item['image'] ?>">
      <?php } ?>
      ...
      <?php if( $list_item['badge_text'] ) { ?> 
        <span class="vf-badge vf-badge--<?php echo $list_item['badge_style'] ?>"><?php echo $list_item['badge_text'] ?></span>         
      <?php } ?>

      <?php if( $list_item['meta_information'] ) { ?> 
        <p class="vf-links__meta"><?php echo $list_item['meta_information'] ?></p>
      <?php } ?>
