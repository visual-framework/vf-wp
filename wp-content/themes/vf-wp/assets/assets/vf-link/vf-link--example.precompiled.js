...
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "link_href"), env.opts.autoescape);
output += "\" class=\"vf-link vf-link--hover\">A text link with :hover</a><br/>\n  <!-- Primary Visited -->\n  <a href=\"";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "link_href"), env.opts.autoescape);
output += "\" class=\"vf-link vf-link--visited\">A text link with :visited</a><br/>\n  <!-- Primary Disabled -->\n  <a href=\"";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "link_href"), env.opts.autoescape);
output += "\" class=\"vf-link\" disabled>A text link that is disabled</a><br/>\n\n  <p class=\"vf-u-margin__bottom--0 vf-text-body vf-text-body--2\">This is an example of using <a href=\"";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "link_href"), env.opts.autoescape);
