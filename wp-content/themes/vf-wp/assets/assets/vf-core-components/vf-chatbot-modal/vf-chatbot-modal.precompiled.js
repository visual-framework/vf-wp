/**
 * Precompiled Nunjucks template: vf-chatbot-modal.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["vf-chatbot-modal"] = (function() {
...
output += "<!-- Modal Chatbot -->\n<div class=\"vf-content vf-chatbot-modal-container\" role=\"dialog\" aria-label=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "config")),"title"), env.opts.autoescape);
...
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "config")),"icons")),"minimize"), env.opts.autoescape);
output += "\" alt=\"Minimize chatbot\">\n      </button>\n      <button class=\"vf-chatbot-modal__close\" aria-label=\"Close chatbot\" data-vf-js-chatbot-modal-close>\n        <img src=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "config")),"icons")),"close"), env.opts.autoescape);
output += "\" alt=\"Close chatbot\">\n      </button>\n    </div>\n  </div>\n\n  <div class=\"vf-chatbot-modal | vf-u-background-color-ui--grey--light\" data-vf-js-chatbot-modal>\n    <div class=\"vf-chatbot-modal__content\" data-vf-js-chatbot-modal-content>\n\n      <!-- Welcome Screen -->\n";
...
output += runtime.suppressValue((runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "config")),"behavior")),"show_scrollbar") == false?"vf-chatbot-modal__messages-no-scrollbar":"vf-chatbot-modal__messages"), env.opts.autoescape);
output += "  vf-u-margin__bottom--400\"\n           data-vf-js-chatbot-modal-messages\n           data-auto-scroll=\"";
...
output += "        <div role=\"region\" aria-label=\"Disclaimer banner\" class=\"vf-chatbot-modal__disclaimer\" data-vf-js-chatbot-modal-disclaimer>\n          <div class=\"vf-banner vf-banner--alert vf-banner--info\">\n            <div class=\"vf-banner__content\">\n              <p class=\"vf-banner__text\">";
...
output += "      <div role=\"region\" aria-label=\"footnote\" class=\"vf-chatbot-modal__footnote vf-u-margin__top--200 vf-u-margin__bottom--200\" data-vf-js-chatbot-modal-footnote>\n        ";
...
output += "    </div>\n\n";
env.getExtension("render")["run"](context,"@vf-chatbot-dialog", function(t_8,t_7) {
...
env.getExtension("render")["run"](context,"@vf-chatbot-feedback--positive", function(t_10,t_9) {
if(t_10) { cb(t_10); return; }
output += runtime.suppressValue(t_9, true && env.opts.autoescape);
output += "    </template>\n    <template id=\"feedback-negative-template\">\n";
env.getExtension("render")["run"](context,"@vf-chatbot-feedback--negative", function(t_12,t_11) {
...
env.getExtension("render")["run"](context,"@vf-chatbot-action-prompt",{"action_text": "","action_url": "#"}, function(t_22,t_21) {
