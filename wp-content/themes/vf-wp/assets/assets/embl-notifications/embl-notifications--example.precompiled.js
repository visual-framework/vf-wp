/**
 * Precompiled Nunjucks template: embl-notifications--example.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["embl-notifications--example"] = (function() {
