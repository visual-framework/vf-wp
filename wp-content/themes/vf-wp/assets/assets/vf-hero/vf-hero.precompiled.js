...
output += "\n";
var t_1;
t_1 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"vf_hero_heading");
frame.set("vf_hero_heading", t_1, true);
if(frame.topLevel) {
context.setVariable("vf_hero_heading", t_1);
}
if(frame.topLevel) {
context.addExport("vf_hero_heading", t_1);
}
var t_2;
t_2 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"vf_hero_summary_title");
frame.set("vf_hero_summary_title", t_2, true);
if(frame.topLevel) {
context.setVariable("vf_hero_summary_title", t_2);
}
if(frame.topLevel) {
context.addExport("vf_hero_summary_title", t_2);
}
var t_3;
t_3 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"vf_hero_subheading");
frame.set("vf_hero_subheading", t_3, true);
if(frame.topLevel) {
context.setVariable("vf_hero_subheading", t_3);
}
if(frame.topLevel) {
context.addExport("vf_hero_subheading", t_3);
}
var t_4;
t_4 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"vf_hero_image");
frame.set("vf_hero_image", t_4, true);
if(frame.topLevel) {
context.setVariable("vf_hero_image", t_4);
}
if(frame.topLevel) {
context.addExport("vf_hero_image", t_4);
}
output += "\n";
var t_5;
t_5 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"striped");
frame.set("striped", t_5, true);
if(frame.topLevel) {
context.setVariable("striped", t_5);
}
if(frame.topLevel) {
context.addExport("striped", t_5);
}
var t_6;
t_6 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"inverted");
frame.set("inverted", t_6, true);
if(frame.topLevel) {
context.setVariable("inverted", t_6);
}
if(frame.topLevel) {
context.addExport("inverted", t_6);
}
var t_7;
...
var t_9;
t_9 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"flush");
frame.set("flush", t_9, true);
if(frame.topLevel) {
context.setVariable("flush", t_9);
}
if(frame.topLevel) {
context.addExport("flush", t_9);
}
var t_10;
t_10 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"offset");
frame.set("offset", t_10, true);
if(frame.topLevel) {
context.setVariable("offset", t_10);
}
if(frame.topLevel) {
context.addExport("offset", t_10);
}
var t_11;
t_11 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"block");
frame.set("block", t_11, true);
if(frame.topLevel) {
context.setVariable("block", t_11);
}
if(frame.topLevel) {
context.addExport("block", t_11);
}
var t_12;
t_12 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"centered");
frame.set("centered", t_12, true);
if(frame.topLevel) {
context.setVariable("centered", t_12);
}
if(frame.topLevel) {
context.addExport("centered", t_12);
}
var t_13;
t_13 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"spacing");
frame.set("spacing", t_13, true);
if(frame.topLevel) {
context.setVariable("spacing", t_13);
}
if(frame.topLevel) {
context.addExport("spacing", t_13);
}
output += "\n";
var t_14;
t_14 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"id");
frame.set("id", t_14, true);
if(frame.topLevel) {
context.setVariable("id", t_14);
}
if(frame.topLevel) {
context.addExport("id", t_14);
}
var t_15;
t_15 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"modifier_class");
frame.set("modifier_class", t_15, true);
if(frame.topLevel) {
context.setVariable("modifier_class", t_15);
}
if(frame.topLevel) {
context.addExport("modifier_class", t_15);
}
var t_16;
t_16 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "context")),"override_class");
frame.set("override_class", t_16, true);
if(frame.topLevel) {
context.setVariable("override_class", t_16);
}
if(frame.topLevel) {
context.addExport("override_class", t_16);
}
;
}
output += "\n\n<section\n  class=\"vf-hero\n  ";
...
frame = frame.push();
var t_19 = runtime.fromIterator(runtime.contextOrFrameLookup(context, frame, "vf_hero_text"));
runtime.asyncEach(t_19, 1, function(hero_text, t_17, t_18,next) {
...
if(t_22) { cb(t_22); return; }output += "    </p>\n";
cb()});
}
else {
cb()}
})(function(t_23) {
if(t_23) { cb(t_23); return; }output += "  </div>\n</section>\n";
if(parentTemplate) {
