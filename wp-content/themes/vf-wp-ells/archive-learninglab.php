...
<div class="vf-grid vf-grid__col-3 | vf-content">
  <div class="vf-grid__col--span-2">
    ...
    <p>The EMBL <strong>LearningLABs</strong> are teacher training courses held face-to-face over 2–3 days or virtually across several weeks. All courses provide an update on current scientific research and offer teaching and learning materials that bring real-life science into the classroom. Face-to-face courses include training in laboratory or bioinformatics practices. 
    </p>
    <p>The EMBL <strong>TeachingBASE</strong> workshops are 60-120 minute long teacher training sessions that provide hands-on training on using classroom-ready teaching and learning materials developed by EMBL’s Science Education and Public Engagement office. All TeachingBASE workshops take place live on Zoom. 
    </p>
  </div>
  <div>
  <?php
