...
/**
* 
* Add swiftype Meta Tag to header. 
*/

function swiftype_metadata() {
  echo '<meta class="swiftype" name="what" data-type="string" content="Documents" />';
}
add_action( 'wp_head', 'swiftype_metadata' );
