...
<form class="vf-stack vf-stack-400 | vf-u-margin__bottom--800">
  <fieldset class="vf-form__fieldset vf-stack vf-stack--400 | vf-u-margin__bottom--800" id="checkbox-filter-unit">
    ...
    <div class="vf-form__item vf-form__item--checkbox">
      <input id="unit-<?php echo $counterUni; ?>" type="checkbox" data-jplist-control="checkbox-text-filter"
        ...
        class="vf-form__checkbox checkboxFilter ">
  ...
  <?php foreach ([$currentYear, 2024] as $year) : ?>
    <div class="vf-form__item vf-form__item--checkbox">
      <input id="year-<?php echo $year; ?>" type="checkbox" data-jplist-control="checkbox-text-filter"
        data-path=".year-<?php echo $year; ?>" data-group="awards" data-name="year" data-or="year"
        value="<?php echo $year; ?>" data-id="year<?php echo $year; ?>" class="vf-form__checkbox checkboxFilter ">
      <label for="year-<?php echo $year; ?>" class="vf-form__label">
        <?php echo $year; ?>
        &nbsp;<span data-jplist-control="counter" data-group="awards" data-format="({count})" data-path=".year-<?php echo $year; ?>"
          data-mode="static" data-name="counter-<?php echo $year; ?>" data-filter-type="path"></span>
      </label>
    </div>
  <?php endforeach; ?>
