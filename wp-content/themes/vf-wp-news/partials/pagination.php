<script>
  ...
  function showPage(page) {
    let articles = document.querySelectorAll(".allItems");
    ...
    const visibleArticles = document.querySelectorAll(".allItems:not(.vf-u-display-none)");
  ...
  function updatePaginationLinks() {
    let articleTotal = document.querySelectorAll(".allItems");
  ...
  function sortEvents() {
    ...
    var events = eventsContainer.querySelectorAll(".allItems"); // Select events only within "upcoming-events"
    var eventsArr = [];
    ...
    eventsArr.sort(function (a, b) {
      var aEventTime = a.querySelector("[data-date]");
      var bEventTime = b.querySelector("[data-date]");
