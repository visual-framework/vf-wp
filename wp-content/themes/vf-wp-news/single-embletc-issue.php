...
if( $other_stories ):
 ?>
<section
  class="vf-card-container vf-card-container__col-3 | vf-u-background-color-ui--off-white vf-u-fullbleed vf-u-margin__top--800"
    ...
    <article class="vf-card vf-card--brand vf-card--bordered" style="--vf-card__image--aspect-ratio: 16 / 9;">
      ...
      <div class="vf-card__content | vf-stack vf-stack--400">
        <h3 class="vf-card__heading"><a class="vf-card__link"
            href="<?php echo the_permalink(); ?>"><?php echo the_title(); ?> <svg aria-hidden="true"
