...
<section class="vf-hero vf-hero--1200 | vf-u-fullbleed | vf-u-margin__top--200"
  style="--vf-hero--bg-image: url('https://www.embl.org/files/wp-content/uploads/20240415_awards_hero-scaled.jpg'); margin-bottom: 0; padding: 2rem 0;">
      ...
      <main>
        ...
        $wp_query   = $forthcomingLoop;
         ...
         include(locate_template('partials/vf-summary--awards.php', false, false)); ?>
          <?php endwhile;?>
          <!-- no results control -->
          <article class="vf-summary vf-summary--event" data-jplist-control="no-results" data-group="awards"
...
<?php include(locate_template('partials/pagination-awards.php', false, false)); ?>
