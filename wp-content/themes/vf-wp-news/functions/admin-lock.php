...
add_filter('user_has_cap', 'vf__admin_lock_cap', 10, 3);

function vf__admin_lock_cap($allcaps, $cap, $args) {
 ...
 */
add_action('acf/init', 'vf__admin_lock_field');

function vf__admin_lock_field() {
