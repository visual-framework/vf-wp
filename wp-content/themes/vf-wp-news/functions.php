...
require_once('functions/custom-api.php');
...
// Redirect hiddden teaxonomy terms page to the homepage

function redirect_or_hide_taxonomy_archive() {
  // Check if the request is for a taxonomy archive
  if (is_tax('embl_taxonomy')) {  // Replace 'embl_taxonomy' with your actual taxonomy slug
      $term = get_queried_object();

      // Get the value of the 'field_embl_taxonomy_hidden' ACF field for the current term
      $custom_field = get_field('field_embl_taxonomy_hidden', 'term_' . $term->term_id);

      // Check if the term is marked as hidden (field value = 1)
      if ($custom_field == '1') {
          // Redirect to the homepage if the term is hidden
          wp_redirect(home_url());
          exit;
      }
  }
}
add_action('template_redirect', 'redirect_or_hide_taxonomy_archive');
