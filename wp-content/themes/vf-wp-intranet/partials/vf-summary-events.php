...
$start_time_format = DateTime::createFromFormat('g:i a', $start_time);
$end_date = get_field('vf_event_internal_end_date',$post_id);
$end_time = get_field('vf_event_internal_end_time',$post_id);
$end_time_format = DateTime::createFromFormat('g:i a', $end_time);
$end = DateTime::createFromFormat('j M Y', $end_date);
$end_date_format = DateTime::createFromFormat('g:i a', $end_date);
