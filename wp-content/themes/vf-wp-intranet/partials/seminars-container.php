    ...
    <section
      ...
      <div class="vf-section-header">
        <a href="/internal-information/seminars"
          class="vf-section-header__heading vf-section-header__heading--is-link">Scientific Events and Seminars <svg
          ...
          <p class="vf-section-header__text" style="color: #fff;">Find here all scientific events and seminars organised at the EMBL. Most have been moved to hybrid format to allow all sites to participate.
          </p>
      </div>
        ...
        if( ! empty( $data ) ) {
            ...
            $canceled = $event->field_event_canceled;
              ...
              elseif ($canceled == 'Postponed') {
                ...
                echo '<article class="vf-card vf-card--brand | vf-u-padding--200">';
                ...
                <a href="http://www.google.com/calendar/render?action=TEMPLATE&text=' . $event->title . '&location=' . $event->field_event_venue . '&ctz=Europe/Berlin&dates=' . $calendarStartDate . 'T' . $calendarStartTime . '00/' . $calendarStartDate . 'T' . $calendarEndTime . '00'.'&sprop=name:" target="_blank" rel="nofollow">Add to calendar</a>
               </span>
           </p>';
                //Title
