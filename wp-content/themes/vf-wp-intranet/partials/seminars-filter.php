...
<form class="vf-stack vf-stack-400 | vf-u-margin__bottom--400">
  ...
  <legend class="vf-form__legend">Location</legend>
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      <label for="location-5" class="vf-form__label">EMBL Barcelona</label>
    </div>
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      <label for="location-4" class="vf-form__label">EMBL Grenoble</label>
    </div>
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      <label for="location-3" class="vf-form__label">EMBL Hamburg</label>
    </div>
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      <label for="location-1" class="vf-form__label">EMBL Heidelberg</label>
    </div>
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      <label for="location-6" class="vf-form__label">EMBL Rome</label>
    </div>
    <div class="vf-form__item vf-form__item--checkbox">
