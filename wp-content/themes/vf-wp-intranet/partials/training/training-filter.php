...
<form class="vf-stack vf-stack-400 | vf-u-margin__bottom--800" data-vf-google-analytics-region="training-filters">
  <fieldset class="vf-form__fieldset vf-stack vf-stack--400 | vf-u-margin__bottom--800" id="checkbox-filter-category">
    ...
    <div class="vf-form__item vf-form__item--checkbox">
      <input data-vf-analytics-label="<?php echo $catSlug; ?>" id="category-<?php echo $catSlug; ?>" type="checkbox" data-jplist-control="checkbox-text-filter"
  ...
  <fieldset class="vf-form__fieldset vf-stack vf-stack--400 | vf-u-margin__bottom--800" id="checkbox-filter-year">
    ...
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      data-group="data-group-1"
      data-format="({count})"
      data-path=".year-<?php echo $currentYear + 1; ?>"
      data-mode="static"
    ...
    <div class="vf-form__item vf-form__item--checkbox">
      ...
      data-group="data-group-1"
      data-format="({count})"
      data-path=".year-<?php echo $currentYear; ?>"
      data-mode="static"
  ...
  <fieldset class="vf-form__fieldset vf-stack vf-stack--400 | vf-u-margin__bottom--800" id="checkbox-filter-location">
    ...
    <div class="vf-form__item vf-form__item--checkbox">
      <input data-vf-analytics-label="Online" id="location-7" type="checkbox" data-jplist-control="checkbox-text-filter" data-path=".location" data-group="data-group-1" data-name="location" data-or="location" value="Online" data-id="location6-online" class="vf-form__checkbox checkboxLive inputLive">
    ...
    foreach($location_terms as $term) {
      ?>
    <div class="vf-form__item vf-form__item--checkbox">
      <input data-vf-analytics-label="<?php echo esc_attr($term->slug); ?>" id="location-<?php echo $counterLoc; ?>" type="checkbox" data-jplist-control="checkbox-text-filter"
  ...
  <fieldset class="vf-form__fieldset vf-stack vf-stack--400" id="checkbox-filter-provider">
    ...
    foreach($provider_terms as $term) {
      ...
      ?>
    <div class="vf-form__item vf-form__item--checkbox">
      <input data-vf-analytics-label="<?php echo $term->slug; ?>" id="provider-<?php echo$term->slug; ?>" type="checkbox" data-jplist-control="checkbox-text-filter"
