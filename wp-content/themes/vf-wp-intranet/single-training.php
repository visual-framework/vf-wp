...
$courseLink = get_field('vf-wp-training-url_od',$post_id); 
...
if (get_field('vf-wp-training-training_type') == 'live') {
if (!empty($start_time)) {
...
<div class="vf-grid vf-grid__col-3 | vf-u-grid-gap--800 | vf-content">
  <div class="vf-grid__col--span-2">
    <div>
      <?php if (!empty($type)) { ?>
      <span class="vf-badge vf-badge--primary vf-u-margin__right--200 customBadgeBlue"><?php echo $type; ?>
        Training</span>
      <?php } ?>
      <h1><?php the_title(); ?></h1>
    </div>
...
<div class="vf-grid vf-grid__col-3 | vf-u-grid-gap--800 | vf-content">
  ...
  <div>
    ...
    <?php if (get_field('vf-wp-training-training_type') == 'live') { ?>
    ...
    <hr class="vf-divider | vf-u-margin__bottom--400">
    <?php } ?>
    <p class="vf-text-body vf-text-body--3 vf-u-margin__bottom--100"><span style="font-weight: 600;">Category:</span>
      <span class="vf-u-text-color--grey">
        <?php echo $category; ?>
      </span>
    </p>
    ...
    <?php 
      // Type
      if (get_field('vf-wp-training-training_type') != 'live') { ?>
    <p class="vf-text-body vf-text-body--3 vf-u-margin__bottom--100"><span style="font-weight: 600;">Type:</span>
      <span class="vf-u-text-color--grey">
        <?php echo $odType; ?>
      </span>
    </p>
    ...
    <p class="vf-text-body vf-text-body--3 | vf-u-margin__bottom--100"><span
        style="font-weight: 600;">Provider:</span><span
  ...
  if (get_field('vf-wp-training-training_type') != 'live') { ?>
    <div>
      <a href="<?php echo esc_url($courseLink); ?>" target="_blank"><button
          class="vf-button vf-button--primary vf-button--sm vf-u-margin__bottom--600 vf-u-margin__top--600">
          Start course
        </button></a>
    </div>
    <?php }
    ...
    if(!empty($contact)) { ?>
    <p class="vf-text-body vf-text-body--3"><span style="font-weight: 600;">Contact:</span> <?php echo $contact; ?> </p>
    <?php }
...
if( $alternative_dates ): ?>
    ...
    <ul class="vf-list vf-list--default | vf-list--tight">
      <?php foreach( $alternative_dates as $alternative_date ): 
        ...
        $alternativeStartDateFormatted = DateTime::createFromFormat('Ymd', $alternativeStartDate);
        ?>
      <li class="vf-list__item">
        <a
          href="<?php echo esc_url( $alternativeDatePermalink ); ?>"><?php echo esc_html( $alternativeStartDateFormatted->format('j M Y') ); ?></a>
      </li>
      <?php endforeach; ?>
    </ul>
    <?php endif; ?>
