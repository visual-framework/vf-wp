...
<label class="vf-form__label" for="vf-form__select-topic">Topic</label>
  <select class="vf-form__select | selectCustomWidth" id="vf-form__select-topic" data-jplist-control="select-filter" data-group="data-group-1">
    <option value="0" data-path="default" >Select</option>
    <?php
    foreach($hrTopicsChoices as $value => $label) {
      ?>
      <option  
        data-path=".<?php echo esc_attr($value); ?>" 
...
<div class="vf-form__item vf-stack">
  ...
  <select class="vf-form__select | selectCustomWidth" id="vf-form__select-site" data-jplist-control="select-filter" data-group="data-group-1">
    <option value="0" data-path="default" >Select</option>
    <?php
...
<div class="vf-form__item vf-stack">
  ...
  <select class="vf-form__select | selectCustomWidth" id="vf-form__select-group" data-jplist-control="select-filter" data-group="data-group-1">
    <option value="0" data-path="default" >Select</option>
    <?php
