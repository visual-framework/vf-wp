...
function vf_wp_intranet_teams__init() {
   ...
   */
   ...
   add_action(
    'init',
    'my_contact_init_register'
  );
  
    function my_contact_init_register() {
  
      register_post_type('my_contact', array(
        'labels'              => my_contact_get_labels(),
        'description'         => __('my_contact', 'vfwp'),
        'public'              => false,
        'hierarchical'        => false,
        'exclude_from_search' => false,
        'publicly_queryable'  => true,
        ...
        'show_in_admin_bar'   => true,
        'show_in_rest'        => true,
        'rest_base'           => "my_contact",
        'menu_icon'           => 'dashicons-format-chat',
        'capability_type'     => 'page',
        'supports'            => array('title', 'editor', 'page-attributes', 'excerpt', 'thumbnail'),
        'has_archive'         => false,
        'rewrite'             => array(
          'slug' => 'my_contact-catalogue'
        ),
        'query_var'           => false,
        'can_export'          => true,
        'delete_with_user'    => false,
     ...
     * https://core.trac.wordpress.org/browser/tags/5.4/src/wp-includes/post.php
     */
    function my_contact_get_labels() {
      return array(
        'name'                     => _x( 'My contact', 'My contact type general name', 'vfwp' ),
        'singular_name'            => _x( 'My contact', 'My contact type singular name', 'vfwp' ),
        'add_new'                  => _x( 'Add New', 'My contact', 'vfwp' ),
        'add_new_item'             => __( 'Add New My contact', 'vfwp' ),
        'edit_item'                => __( 'Edit My contact', 'vfwp' ),
        'new_item'                 => __( 'New My contact', 'vfwp' ),
        'view_item'                => __( 'View My contact', 'vfwp' ),
        'view_items'               => __( 'View My contacts', 'vfwp' ),
        'search_items'             => __( 'Search My contacts', 'vfwp' ),
        'not_found'                => __( 'No My contacts found.', 'vfwp' ),
        'not_found_in_trash'       => __( 'No My contacts found in Trash.', 'vfwp' ),
        'parent_item_colon'        => __( 'Parent Page:', 'vfwp' ),
        'all_items'                => __( 'All My contacts', 'vfwp' ),
        'archives'                 => __( 'My contact Archives', 'vfwp' ),
        'attributes'               => __( 'My contact Attributes', 'vfwp' ),
        'insert_into_item'         => __( 'Insert into My contact', 'vfwp' ),
        'uploaded_to_this_item'    => __( 'Uploaded to this My contact', 'vfwp' ),
        'featured_image'           => _x( 'Featured image', 'My contact', 'vfwp' ),
        'set_featured_image'       => _x( 'Set featured image', 'My contact', 'vfwp' ),
        'remove_featured_image'    => _x( 'Remove featured image', 'My contact', 'vfwp' ),
        'use_featured_image'       => _x( 'Use as featured image', 'My contact', 'vfwp' ),
        'filter_items_list'        => __( 'Filter My contacts list', 'vfwp' ),
        'items_list_navigation'    => __( 'My contacts list navigation', 'vfwp' ),
        'items_list'               => __( 'My contacts list', 'vfwp' ),
        'item_published'           => __( 'My contact published.', 'vfwp' ),
        'item_published_privately' => __( 'My contact published privately.', 'vfwp' ),
        'item_reverted_to_draft'   => __( 'My contact reverted to draft.', 'vfwp' ),
        'item_scheduled'           => __( 'My contact scheduled.', 'vfwp' ),
        'item_updated'             => __( 'My contact updated.', 'vfwp' ),
      );
    }
