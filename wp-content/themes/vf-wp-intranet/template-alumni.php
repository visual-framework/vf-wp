...
<section class="vf-intro | vf-u-margin__bottom--0">
  ...
  <div class="vf-stack | vf-content">
    ...
    <h2 class="vf-intro__subheading" style="margin-bottom: 2rem;">Welcome to the EMBL Alumni Directory, a resource designed to help current staff and fellows connect with former EMBL members. </h2>
    <p class="vf-intro__text">Use the directory to find alumni by name, organisation, location, area of expertise, or graduation year, and discover opportunities for networking, collaboration, mentoring, and career development</p>
...
<div class="vf-u-background-color-ui--off-white">
  ...
  <div class="vf-content vf-u-padding--400">
    <p class="vf-text-body vf-text-body--3 | vf-u-margin__bottom--400">
      <a href="mailto:alumni@embl.org">Contact the Alumni Team</a> if you would like to connect with any alumni or have any questions.
    </p>
<hr class="vf-divider | vf-u-margin__bottom--400">


    <p class="vf-text-body vf-text-body--3 | vf-u-margin__bottom--400">
      <a href="https://www.embl.org/about/info/alumni/">More information about EMBL Alumni Relations</a>
    </p>

    <p class="vf-text-body vf-text-body--3 | vf-u-margin__bottom--400">
      <a href="https://www.youtube.com/@EMBLAlumniRelations">EMBL Alumni YouTube Channel</a>
    </p>

    <p class="vf-text-body vf-text-body--3 | vf-u-margin__bottom--0">
      <a href="https://www.linkedin.com/showcase/embl-alumni/?viewAsMember=true">EMBL Alumni LinkedIn Page</a>
    </p>
  </div>
</div>
</div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function normalizeAlumniRecord(record) {
    ...
    const jobcategory = getAlumniField(record, ["jobcategory", "jobCategory", "job_category", "jobCategories", "job_categories"], "");
