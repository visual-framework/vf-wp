<?php
/*
Plugin Name: VF-WP Hero Custom Blog
Description: VF-WP Hero for blog pages.
...
class VF_WP_Hero_Blog extends VF_Plugin {
  ...
  protected $config = array(
    'post_name'  => 'vf_wp_hero_blog',
    'post_title' => 'VF Hero Blog',
    'post_type'  => 'vf_container'
  );

  public function __construct(array $params = array()) {
    parent::__construct('vf_wp_hero_blog');
