<?php
/*
Plugin Name: VF-WP Hero Secondary
Description: VF-WP Hero secondary container.
...
class VF_WP_Hero_Secondary extends VF_Plugin {
  ...
  protected $config = array(
    'post_name'  => 'vf_wp_hero_secondary',
    'post_title' => 'VF Hero Secondary',
    'post_type'  => 'vf_container'
  );

  public function __construct(array $params = array()) {
    parent::__construct('vf_wp_hero_secondary');
