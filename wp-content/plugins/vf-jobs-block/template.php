...
<?php
// Check if the content contains any HTML element with the class 'vf-summary--job'
$has_job_positions = strpos($content, 'class="vf-summary vf-summary--job"') !== false;
...
if ($has_job_positions) { ?>
  <div class="embl-grid embl-grid--has-centered-content | vf-u-margin__top--800">
      ...
      <div class="vf-section-header">
        <h2 class="vf-section-header__heading">
          <a class="vf-section-header__heading vf-section-header__heading--is-link" 
             href="<?php echo esc_url($section_header_link); ?>" 
             id="section-link">
    ...
    <div>
<?php } else {
  echo '<!-- No job positions found, hiding the section header. -->';
}
