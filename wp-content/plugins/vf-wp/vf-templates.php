...
class VF_Templates {
  ...
  static public function is_template_post($post, $post_name = '') {
    ...
    if (($theme == 'VF-WP Intranet') && ((is_search()) || (is_page_template('searchpage.php')))) {
     ...
     if (($theme == 'VF-WP EMBL-EBI Events') && ((is_front_page()) || (is_page_template(array('template-seminars.php', 'template-public-events-archive.php', 'template-seminars-archive.php', 'single-events.php', 'template-breadcrumbs.php', 'template-internal-events-archive.php', 'template-internal-events.php'))))) {
      return false;
     }
