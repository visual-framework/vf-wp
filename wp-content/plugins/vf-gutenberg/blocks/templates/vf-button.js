/**
 * Precompiled Nunjucks template: @visual-framework/vf-button
 */
...
t_1 += " href=\"";
t_1 += runtime.suppressValue((runtime.contextOrFrameLookup(context, frame, "href")?runtime.contextOrFrameLookup(context, frame, "href"):"#"), env.opts.autoescape);
t_1 += "\"";
;
}
t_1 += "\n";
