    ...
    <div role="region" aria-label="Chatbot header" class="vf-chatbot-modal__header">
      <div role="region" aria-label="Chatbot selector" class="vf-chatbot-modal__header-left">
        <div
          ...
          data-routes-path="/wp-content/themes/vf-wp/assets/assets/vf-chatbot/assets/vf-chatbot-selector-services.json"
          ...
          <button class="vf-chatbot-selector__title" data-vf-js-selector-toggle type="button">
            ...
            <span class="vf-chatbot-selector__chevron">
              <svg width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#vf-chatbot-selector-clip)">
                ...
                <defs>
                  <clipPath id="vf-chatbot-selector-clip">
    ...
    <div class="vf-chatbot-modal | vf-u-background-color-ui--grey--light" data-vf-js-chatbot-modal>
      <div class="vf-chatbot-modal__content" data-vf-js-chatbot-modal-content>
        <div
          ...
          data-qa-data-url="/wp-content/themes/vf-wp/assets/assets/vf-chatbot/assets/vf-chatbot-qa.json"
        >
  ...
  (function () {
    ...
    window.vfEventChatbotConfig = {
      ...
      api: {
        ...
        qa_data_url: assetBase + "/vf-chatbot-qa.json",
        headers: {
      ...
      selectorContext: {
        chatbotRoutes: {
          ...
          routes: assetBase + "/vf-chatbot-selector-services.json",
          placeholder: "Select services",
          title: "Services",
          selector_logo_url: assetBase + "/vf-chatbot--icon-24x24-dark-green.svg",
          selector_logo_title: "Event Assistant"
        }
      },
      feedback_options: {
        positive: [
